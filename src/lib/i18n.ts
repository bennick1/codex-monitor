...
export const copy = {
  "zh-CN": {
    ...
    settingsReadFailed: "设置读取失败，暂时使用默认设置。请重启 Codex Monitor；若仍出现，请联系开发者。",
  ...
  en: {
    ...
    settingsReadFailed: "Settings could not be read. Defaults are temporarily in use. Restart Codex Monitor; if this continues, contact the developer.",
